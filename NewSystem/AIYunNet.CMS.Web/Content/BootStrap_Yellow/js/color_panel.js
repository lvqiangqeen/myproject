...
$(document).ready(function(){
	...
	$('.color_item a').click(function(){
		...
		$('#theme_color').attr('href', '/content/BootStrap_Yellow/css/colors/' + set_color + '.css');
