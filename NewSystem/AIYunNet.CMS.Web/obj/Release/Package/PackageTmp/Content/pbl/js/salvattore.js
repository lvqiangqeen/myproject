...
(this,function () {
    ...
    function () {
            ...
            r = setTimeout(function () {
                ...
                n = a.length; n > t; t++) {
                    ...
                    if (o !== r.matches) {
                        r.matches = o;
                        for (var c = 0,
                        l = i.length; l > c; c++) i[c].call(window, r)
                    }
                }
            },
            30)
        ...
        window.matchMedia = function (r) {
            ...
            o.removeListener = function (e) {
                for (var t = 0,
                n = c.length; n > t; t++) c[t] === e && c.splice(t, 1)
            },
            o
        }
    }(),
    ...
    var e = function (e, t, n) {
        ...
        r.addColumns = function (e, n) {
            for (var a, i = r.obtainGridSettings(e), o = i.numberOfColumns, l = i.columnClasses, s = new Array(+o), u = t.createDocumentFragment(), d = o; 0 !== d--;) a = "[data-columns] > *:nth-child(" + o + "n-" + d + ")",
        ...
        r.removeColumns = function (n) {
            ...
            var a = Array.prototype.filter.call(r.extractContents().childNodes,
            function (t) {
            ...
            function (e, t) {
                Array.prototype.forEach.call(e.children,
                function (e, n) {
                    l[n * i + t] = e
                })
            });
        ...
        r.scanMediaQueries = function () {
            ...
            if (e.matchMedia) {
                r.getStylesheets().forEach(function (e) {
                    Array.prototype.forEach.call(r.getCSSRules(e),
                    function (e) {
                        try {
